...
def stakan_size(n, g):
    if int(current_task[n]) == max(list(map(int, current_task[0:stakans_amount]))):
        ...
        return 75 + (int(current_task[n]) - min(list(map(int, current_task[0:stakans_amount])))) * (50 / (
                max(list(map(int, current_task[0:stakans_amount]))) - min(
            list(map(int, current_task[0:stakans_amount])))))
...
class stakan(pygame.sprite.Sprite):
    ...
    def work1(self, size1, size2, size3, size4, mousex, mousey, tap, need):
        ...
        if stakans_amount < 4:
            ...
            if stakans_amount < 3:
                size3 = 0
                have3 = 0
        if ((mousex > space + stakan1.x // 2 - 60 and mousex < space + stakan1.x // 2 + 60) and (
                mousey < 479 and mousey > 434)):
        ...
        if pouring_1 or chosen == 'ограниченный долив':
            screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 25).render('ВЫЛИТЬ', 1, (1, 1, 1)),
                        (space + stakan1.x // 2 - 35, 507))
        else:
            screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 25).render('ЗАПОЛНИТЬ', 1, (1, 1, 1)),
                        (space + stakan1.x // 2 - 52, 507))
        screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 25).render('ПЕРЕЛИТЬ', 1, (1, 1, 1)),
                    (space + stakan1.x // 2 - 44, 448))
        ...
        if (mousex > 15 and mousex < 65) and (mousey < 135 and mousey > 70) and tap:
            ...
            if stakans_amount > 3:
                have4 = 0
        if ((mousex > space + stakan1.x // 2 - 60 and mousex < space + stakan1.x // 2 + 60) and (
                mousey < 537 and mousey > 492)) and tap:
            if pouring_1:
                sound1.stop()
                sound2.stop()
                sound1.play(0)
                ...
                have1 = size1
                action += 1
        elif ((mousex > space + stakan1.x // 2 - 60 and mousex < space + stakan1.x // 2 + 60) and (
                mousey < 479 and mousey > 434)) and tap and have1 != 0:
            action += 1
            h1 = 0
            while h1 == 0:
                if previous_water_1 != 0:
                    pygame.draw.rect(screen, (64, 128, 255),
                                     (space, 390 - previous_water_1, stakan1.x, previous_water_1))
                for i in pygame.event.get():
                    if i.type == pygame.MOUSEBUTTONDOWN:
                        if i.button == 1:
                            ...
                            sound2.stop()
                            sound.play(0)
                            if (i.pos[0] > space * 2 + stakan1.x and i.pos[0] < space * 2 + stakan1.x + stakan2.x) and (
                                    i.pos[1] > 390 - stakan2.y and i.pos[1] < 390) and have2 != size2:
                                sound1.stop()
                                sound2.stop()
                                sound1.play(0)
                                have2 = have1 + have2
                                ...
                                h1 = 1
                            if stakans_amount > 2:
                                if (i.pos[0] > space * 3 + stakan1.x + stakan2.x and i.pos[
                                    0] < space * 3 + stakan1.x + stakan2.x + stakan3.x) and (
                                        i.pos[1] > 390 - stakan3.y and i.pos[1] < 390) and have3 != size3:
                                    sound1.stop()
                                    sound2.stop()
                                    sound1.play(0)
                                    have3 = have1 + have3
                                    ...
                                    h1 = 1
                                if stakans_amount > 3:
                                    if (i.pos[0] > space * 4 + stakan1.x + stakan2.x + stakan3.x and i.pos[
                                        0] < space * 4 + stakan1.x + stakan2.x + stakan3.x + stakan4.x) and (
                                            i.pos[1] > 390 - stakan4.y and i.pos[1] < 390) and have4 != size4:
                                        sound1.stop()
                                        sound2.stop()
                                        sound1.play(0)
                                        have4 = have1 + have4
    ...
    def work2(self, size1, size2, size3, size4, mousex, mousey, tap, need):
        ...
        if stakans_amount < 4:
            ...
            if stakans_amount < 3:
                ...
                size3 = 0
        if ((
                mousex > space * 2 + stakan1.x + stakan2.x // 2 - 60 and mousex < space * 2 + stakan1.x + stakan2.x // 2 + 60) and (
                mousey < 479 and mousey > 434)):
        ...
        if previous_water_2 != 0:
            pygame.draw.rect(screen, (64, 128, 255),
                             (space * 2 + stakan1.x, 390 - previous_water_2, stakan2.x, previous_water_2))
        ...
        if pouring_2 or chosen == 'ограниченный долив':
            screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 25).render('ВЫЛИТЬ', 1, (1, 1, 1)),
                        (space * 2 + stakan1.x + stakan2.x // 2 - 35, 507))
        else:
            screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 25).render('ЗАПОЛНИТЬ', 1, (1, 1, 1)),
                        (space * 2 + stakan1.x + stakan2.x // 2 - 52, 507))
        screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 25).render('ПЕРЕЛИТЬ', 1, (1, 1, 1)),
                    (space * 2 + stakan1.x + stakan2.x // 2 - 44, 448))
        ...
        if ((
            ...
            if pouring_2:
                ...
                action += 1
                      ...
                      mousex > space * 2 + stakan1.x + stakan2.x // 2 - 60 and mousex < space * 2 + stakan1.x + stakan2.x // 2 + 60) and (
                      mousey < 479 and mousey > 434)) and tap and have2 != 0:
            action += 1
            h2 = 0
            while h2 == 0:
                for x in pygame.event.get():
                    if x.type == pygame.MOUSEBUTTONDOWN:
                        if x.button == 1:
                            ...
                            sound2.stop()
                            sound.play(0)
                            if (x.pos[0] > space and x.pos[0] < space + stakan1.x) and (
                                    x.pos[1] < 390 and x.pos[1] > 390 - stakan1.y) and have1 != size1:
                                sound1.stop()
                                sound2.stop()
                                sound1.play(0)
                                have1 = have2 + have1
                                ...
                                h2 = 1
                            if stakans_amount > 2:
                                if (x.pos[0] > space * 3 + stakan1.x + stakan2.x and x.pos[
                                    0] < space * 3 + stakan1.x + stakan2.x + stakan3.x) and (
                                        x.pos[1] > 390 - stakan3.y and x.pos[1] < 390) and have3 != size3:
                                    sound1.stop()
                                    sound2.stop()
                                    sound1.play(0)
                                    have3 = have2 + have3
                                    ...
                                    h2 = 1
                                if stakans_amount > 3:
                                    if (x.pos[0] > space * 4 + stakan1.x + stakan2.x + stakan3.x and x.pos[
                                        0] < space * 4 + stakan1.x + stakan2.x + stakan3.x + stakan4.x) and (
                                            x.pos[1] > 390 - stakan4.y and x.pos[1] < 390) and have4 != size4:
                                        sound1.stop()
                                        sound2.stop()
                                        sound1.play(0)
                                        have4 = have2 + have4
    ...
    def work3(self, size1, size2, size3, size4, mousex, mousey, tap, need):
        ...
        if stakans_amount < 4:
            size4 = 0
        if ((
                mousex > space * 3 + stakan1.x + stakan2.x + stakan3.x // 2 - 60 and mousex < space * 3 + stakan1.x + stakan2.x + stakan3.x // 2 + 60) and (
                mousey < 479 and mousey > 434)):
        ...
        if previous_water_3 != 0:
            pygame.draw.rect(screen, (64, 128, 255),
                             (space * 3 + stakan1.x + stakan2.x, 390 - previous_water_3, stakan3.x, previous_water_3))
        screen.blit(scale(pygame.image.load("stakan.png"), (self.x, self.y)),
                    (space * 3 + stakan1.x + stakan2.x, 390 - self.y))
        if ((
                mousex > space * 3 + stakan1.x + stakan2.x + stakan3.x // 2 - 60 and mousex < space * 3 + stakan1.x + stakan2.x + stakan3.x // 2 + 60) and (
                mousey < 537 and mousey > 492)):
        ...
        if pouring_3 or chosen == 'ограниченный долив':
            screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 25).render('ВЫЛИТЬ', 1, (1, 1, 1)),
                        (space * 3 + stakan1.x + stakan2.x + stakan3.x // 2 - 35, 507))
        else:
            screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 25).render('ЗАПОЛНИТЬ', 1, (1, 1, 1)),
                        (space * 3 + stakan1.x + stakan2.x + stakan3.x // 2 - 52, 507))
        screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 25).render('ПЕРЕЛИТЬ', 1, (1, 1, 1)),
                    (space * 3 + stakan1.x + stakan2.x + stakan3.x // 2 - 44, 448))
        ...
        if ((
            ...
            if pouring_3:
                ...
                action += 1
                      ...
                      mousex > space * 3 + stakan1.x + stakan2.x + stakan3.x // 2 - 60 and mousex < space * 3 + stakan1.x + stakan2.x + stakan3.x // 2 + 60) and (
                      mousey < 479 and mousey > 434)) and tap and have3 != 0:
            action += 1
            h3 = 0
            while h3 == 0:
                for p in pygame.event.get():
                    if p.type == pygame.MOUSEBUTTONDOWN:
                        if p.button == 1:
                            ...
                            sound2.stop()
                            sound.play(0)
                            if (p.pos[0] > space and p.pos[0] < space + stakan1.x) and (
                                    p.pos[1] < 390 and p.pos[1] > 390 - stakan1.y) and have1 != size1:
                                sound1.stop()
                                sound2.stop()
                                sound1.play(0)
                                have1 = have3 + have1
                                ...
                                if have1 > size1:
                                    ...
                                    have1 = size1
                                h3 = 1
                            elif (p.pos[0] > space * 2 + stakan1.x and p.pos[
                                0] < space * 2 + stakan1.x + stakan2.x) and (
                                    p.pos[1] > 390 - stakan2.y and p.pos[1] < 390) and have2 != size2:
                                sound1.stop()
                                sound2.stop()
                                sound1.play(0)
                                have2 = have3 + have2
                                ...
                                h3 = 1
                            if stakans_amount > 3:
                                if (p.pos[0] > space * 4 + stakan1.x + stakan2.x + stakan3.x and p.pos[
                                    0] < space * 4 + stakan1.x + stakan2.x + stakan3.x + stakan4.x) and (
                                        p.pos[1] > 390 - stakan4.y and p.pos[1] < 390) and have4 != size4:
                                    sound1.stop()
                                    sound2.stop()
                                    sound1.play(0)
                                    have4 = have3 + have4
    ...
    def work4(self, size1, size2, size3, size4, mousex, mousey, tap, need):
        ...
        if have4 != 0:
            ...
            pouring_4 = False
        if ((
                mousex > space * 4 + stakan1.x + stakan2.x + stakan3.x + stakan4.x // 2 - 60 and mousex < space * 4 + stakan1.x + stakan2.x + stakan3.x + stakan4.x // 2 + 60) and (
                mousey < 479 and mousey > 434)):
        ...
        if previous_water_4 != 0:
            pygame.draw.rect(screen, (64, 128, 255), (
                space * 4 + stakan1.x + stakan2.x + stakan3.x, 390 - previous_water_4, stakan4.x, previous_water_4))
        screen.blit(scale(pygame.image.load("stakan.png"), (self.x, self.y)),
                    (space * 4 + stakan1.x + stakan2.x + stakan3.x, 390 - self.y))
        if ((
                mousex > space * 4 + stakan1.x + stakan2.x + stakan3.x + stakan4.x // 2 - 60 and mousex < space * 4 + stakan1.x + stakan2.x + stakan3.x + stakan4.x // 2 + 60) and (
                mousey < 537 and mousey > 492)):
        ...
        if pouring_4 or chosen == 'ограниченный долив':
            screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 25).render('ВЫЛИТЬ', 1, (1, 1, 1)),
                        (space * 4 + stakan1.x + stakan2.x + stakan3.x + stakan4.x // 2 - 35, 507))
        else:
            screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 25).render('ЗАПОЛНИТЬ', 1, (1, 1, 1)),
                        (space * 4 + stakan1.x + stakan2.x + stakan3.x + stakan4.x // 2 - 52, 507))
        screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 25).render('ПЕРЕЛИТЬ', 1, (1, 1, 1)),
                    (space * 4 + stakan1.x + stakan2.x + stakan3.x + stakan4.x // 2 - 44, 448))
        ...
        if ((
            ...
            if pouring_4:
                ...
                action += 1
                      ...
                      mousex > space * 4 + stakan1.x + stakan2.x + stakan3.x + stakan4.x // 2 - 60 and mousex < space * 4 + stakan1.x + stakan2.x + stakan3.x + stakan4.x // 2 + 60) and (
                      mousey < 479 and mousey > 434)) and tap and have4 != 0:
            action += 1
            h4 = 0
            while h4 == 0:
                for p in pygame.event.get():
                        ...
                        if p.button == 1:
                            ...
                            if (p.pos[0] > space and p.pos[0] < space + stakan1.x) and (
                                ...
                                if have2 > size2:
                                    ...
                                    have2 = size2
                                h4 = 1
                            elif (p.pos[0] > space * 3 + stakan1.x + stakan2.x and p.pos[
                                0] < space * 3 + stakan1.x + stakan2.x + stakan3.x) and (
                                    p.pos[1] > 390 - stakan3.y and p.pos[1] < 390) and have3 != size3:
                                sound1.stop()
                                sound2.stop()
                                sound1.play(0)
                                have3 = have4 + have3
...
while True:
    ...
    if task:
        ...
        stakan1.work1(int(current_task[0]), int(current_task[1]), int(current_task[2]), int(current_task[3]), w[0],
                      w[1], tap, need)
        stakan2.work2(int(current_task[0]), int(current_task[1]), int(current_task[2]), int(current_task[3]), w[0],
                      w[1], tap, need)
        if stakans_amount > 2:
            stakan3.work3(int(current_task[0]), int(current_task[1]), int(current_task[2]), int(current_task[3]), w[0],
                          w[1], tap, need)
        if stakans_amount > 3:
            stakan4.work4(int(current_task[0]), int(current_task[1]), int(current_task[2]), int(current_task[3]), w[0],
                          w[1], tap, need)
        ...
        screen.blit(
            pygame.font.SysFont('Comic Sans MS', 22).render('ТРЕБОВАЛОСЬ ПОЛУЧИТЬ ЛИТРОВ: ' + str(need), 1, (1, 1, 1)),
            (160, 290))
        screen.blit(
            pygame.font.SysFont('Comic Sans MS', 22).render('СКОЛЬКО ХОДОВ ПОТРЕБОВАЛОСЬ: ' + str(action_answer), 1,
                                                            (1, 1, 1)), (160, 355))
        screen.blit(
            pygame.font.SysFont('Comic Sans MS', 22).render('РЕКОРД ПО ХОДАМ: ' + str(current_task[-1]), 1, (1, 1, 1)),
            (240, 420))
        ...
        name = pygame.font.Font('19369.ttf', 100).render('NALIVAY', False, (1, 1, 1))
        ...
        if tasks_texts != '':
            ...
            for i in range(1, 7):
                if page * 6 + i <= tasks_amount:
                    if i == 1:
                        if pygame.mouse.get_pos()[0] in range(100, 336) and pygame.mouse.get_pos()[1] in range(125,
                                                                                                               210):
                        ...
                        screen.blit(pygame.font.SysFont('Comic Sans MS', 22).render('ЗАДАЧА ' + str(page * 6 + i), 1,
                                                                                    (1, 1, 1)), (105, 130))
                        result_i = page * 6 + i
                        ...
                        screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 20).render(
                            'ВАШ РЕЗУЛЬТАТ: ' + tasks_texts[page * 6 + i - 1].split()[-2], 1, (1, 1, 1)), (105, 180))
                    elif i == 2:
                        if pygame.mouse.get_pos()[0] in range(100, 336) and pygame.mouse.get_pos()[1] in range(260,
                                                                                                               345):
                        ...
                        screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 20).render(
                            'ВАШ РЕЗУЛЬТАТ: ' + tasks_texts[page * 6 + i - 1].split()[-2], 1, (1, 1, 1)), (105, 315))
                    elif i == 3:
                        if pygame.mouse.get_pos()[0] in range(100, 336) and pygame.mouse.get_pos()[1] in range(395,
                                                                                                               480):
                        ...
                        screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 20).render(
                            'ВАШ РЕЗУЛЬТАТ: ' + tasks_texts[page * 6 + i - 1].split()[-2], 1, (1, 1, 1)), (105, 450))
                    elif i == 4:
                        if pygame.mouse.get_pos()[0] in range(414, 650) and pygame.mouse.get_pos()[1] in range(125,
                                                                                                               210):
                        ...
                        screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 20).render(
                            'ВАШ РЕЗУЛЬТАТ: ' + tasks_texts[page * 6 + i - 1].split()[-2], 1, (1, 1, 1)), (419, 180))
                    elif i == 5:
                        if pygame.mouse.get_pos()[0] in range(414, 650) and pygame.mouse.get_pos()[1] in range(260,
                                                                                                               345):
                        ...
                        screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 20).render(
                            'ВАШ РЕЗУЛЬТАТ: ' + tasks_texts[page * 6 + i - 1].split()[-2], 1, (1, 1, 1)), (419, 315))
                    else:
                        if pygame.mouse.get_pos()[0] in range(414, 650) and pygame.mouse.get_pos()[1] in range(395,
                                                                                                               480):
                        ...
                        screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 20).render(
                            'ВАШ РЕЗУЛЬТАТ: ' + tasks_texts[page * 6 + i - 1].split()[-2], 1, (1, 1, 1)), (419, 450))
            ...
            if e.type == pygame.MOUSEBUTTONUP and e.button == 1:
                if e.pos[0] in range(310, 360) and e.pos[1] in range(490, 540) and page != 0 and MOUSEBUTTONDOWN_2:
                    page -= 1
                if e.pos[0] in range(390, 440) and e.pos[1] in range(490,
                                                                     540) and result_i < tasks_amount and MOUSEBUTTONDOWN_2:
                    page += 1
                MOUSEBUTTONDOWN_2 = False
        else:
            screen.blit(pygame.font.SysFont('Nunito-ExtraLight.ttf', 30).render('ЗАДАЧИ ЭТОГО ТИПА ЕЩЁ НЕ ДОБАВЛЕНЫ', 1,
                                                                                (1, 1, 1)), (145, 295))
